import { PerformMove } from "@/types/types"
import { copyPosition } from "../helper"

export const movePiece = ({ position, piece, rank, file, x, y }: PerformMove) => {
...
export const movePawn = ({ position, piece, rank, file, x, y }: PerformMove) => {
    const newPosition = copyPosition(position)
